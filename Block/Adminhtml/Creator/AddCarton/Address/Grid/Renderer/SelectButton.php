 ...
 */
namespace ITvoice\AsnCreator\Block\Adminhtml\Creator\AddCarton\Address\Grid\Renderer;
...
class SelectButton extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        return $this->getLayout()->createBlock(
            ...
            'Select',
            'window.selectedAddressId = "' . $row->getId() . '"; window.selectCartonAddressModal.modal(\'closeModal\')',
            '',
            ''
        );
    }
